...
#define TRACE16_RPMSG_FAILED            0x00010000
...
#define SKETCH_STATE_NOT_RUNNING        0
#define SKETCH_STATE_RUNNING            1
#define SKETCH_STATE_LOCKED             2
#define SKETCH_STATE_FAILED             3
